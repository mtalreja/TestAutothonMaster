...
//				element.SendKeys("executeautomation");
		...
		private static By translateBy(By by){
			...
			else if((Accessor.driverIsForIOS()) && byString.StartsWith("By.XPath: ") && TestSuite.Current.Parameters["Version"].Equals("10",StringComparison.CurrentCultureIgnoreCase))
			{
			...
			else if((!Accessor.driverIsForAndroid() && !Accessor.driverIsForIOS()) && byString.StartsWith("By.Name: "))
			{
				String name = byString.Substring(9);
				String translatedXPath = "//*[@name='"+ name +"']";
				return By.XPath(translatedXPath);
